...
export default function InstitutionItem({id, produto, quantidade, valor, action, editAction}) {
    ...
    return(
        <div className="institutionTableList">
